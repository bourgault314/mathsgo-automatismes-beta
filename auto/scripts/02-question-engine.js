Warning: truncated output (original token count: 60334)
Total output lines: 3991
...
function makeFractionPercentInstance(mod,q){
  ...
  if(category==='fraction'){
    ...
    const level=(typeof document!=='undefined'&…10334 tokens truncated…O_VISUALS.get('geometry.pythagoras-reasoning');
