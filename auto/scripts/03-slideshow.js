...
function setModuleClasses(diapo,moduleId){
 ...
 diapo.classList.toggle('dense-mode',['dnb_15','dnb_26','dnb_26b','dnb_32','dnb_33','dnb_36','dnb_37'].includes(moduleId));
}
