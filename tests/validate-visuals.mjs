...
const relationHashes=new Map([
  ...
  ['predecesseur',['d16314da1b71fc16deda28af15ad7ac89e3abf00e49995ae3c���z��
�)�֧u�ݢ�i��k�G��*^ecf01ce3664286','41244493ef0baf1d98a4f7ca3d07b5d19be312e77fc80d471f661dbf1db64ebd']],
...
for(const preset of equalSharing?.presets||[]){
  ...
  for(const correctionState of [false,true]){
    const���z��
�)�֧u�ݢ�i��k�G��*^ actual=hash(equalSharing.render(preset.data,correctionState));
