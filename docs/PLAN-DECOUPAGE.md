...
1. Installer les tests de structure et figer l’état V1.15.
2. Définir le contrat commun d’un module.
3. Extraire deux modules pilotes : un simple et un très visuel.
